...
export const GROOM_CONTACTS: ContactPerson[] = [
  { role: '신랑부', name: '정동준', phone: '010-6393-1476', bank: '우리', account: '436-036965-02-001' },
  { role: '신랑모', name: '권춘자', phone: '010-3136-1476', bank: '국민', account: '573101-01-262270' },
  { role: '신랑', name: '정민수', phone: '010-9133-1476', bank: '국민', account: '573101-01-562219' },
]

export const BRIDE_CONTACTS: ContactPerson[] = [
  { role: '신부부', name: '김정식', phone: '010-4113-7244', bank: '농협', account: '352-1315-4154-73' },
  { role: '신부모', name: '김봉순', phone: '010-5480-2703', bank: '농협', account: '351-0301-6119-63' },
